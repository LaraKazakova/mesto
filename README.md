# Репозиторий проектной работы № 4-5-6
...
валидация со стандартными ошибками браузера, использование объекта с настройками, свойства валидности формы и её элементов, события input и keyup.<br>
